...
const Profiles = () => {
  ...
  console.log(studentDetails.personalDetails)

  return (
    <div className=''>
      <div className="flex gap-20 p-4 w-full bg-[#f9f8fd] justify-center flex-wrap">
        {studentDetails.map((details) => (
          ...
          >
            ...
            <div className='flex justify-between items-center'>
              <p className="rounded bg-[#d9f4fd] text-[#2e8bb6] font-bold p-1">{details.status}</p>
              <img src="../src/assets/edumpus.jpg" className='border-[2px] rounded-full w-10 h-10' alt="" />
            </div>
          </div>
        ))}
      </div>
